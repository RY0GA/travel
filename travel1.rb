...
while true
  print "人数を入力>"
  #予約人数を入力する処理
  num_of_reservations = gets.to_i
  break if (num_of_reservations >= 1)
    puts "1以上の数を入力してください"
end

#入力された人数を表示
puts "#{num_of_reservations}名ですね。"

#合計金額を計算する処理
total_price = chosen_plan[:price] * num_of_reservations
#割引料金を計算する処理
discount_total_price = (total_price * 0.9).floor

#割引料金が適応されるか判断する処理
if num_of_reservations >= 5
  puts "#{num_of_reservations}名以上ですので10％％割引になります"
